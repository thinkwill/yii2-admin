...
namespace thinkwill\admin\components;
 ...
 * 
 * ```
 * Yii::$container->set('thinkwill\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
{
    const CACHE_TAG = 'thinkwill.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'thinkwill.admin.configs', []);
